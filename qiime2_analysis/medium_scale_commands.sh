...
qiime diversity core-metrics-phylogenetic --i-phylogeny rooted-tree.qza  --i-table table.qza --p-sampling-depth $MIN --output-dir core-metrics-results --m-metadata-file metadata.txt

#alpha diversity
qiime diversity alpha-rarefaction --i-table table.qza --i-phylogeny rooted-tree.qza --p-max-depth $MAX --m-metadata-file metadata.txt --o-visualization alpha-rarefaction.qzv
