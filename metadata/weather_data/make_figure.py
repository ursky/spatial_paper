...
ax1.set_xlabel("SG1 temp ($^\circ$C)")
ax1.set_ylabel("SG2 temp ($^\circ$C)")
ax4.set_xlabel("SG1-Bot temp ($^\circ$C)")
ax4.set_ylabel("SG1-Top temp ($^\circ$C)")

ax2.set_xlabel("SG1 rel. humidity (%)")
ax2.set_ylabel("SG2 rel. humidity (%)")
ax5.set_xlabel("SG1-Bot rel. humidity (%)")
ax5.set_ylabel("SG1-Top. humidity (%)")
