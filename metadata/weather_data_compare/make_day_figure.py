...
# SG1 Bot?
#data["top"] = load_data("SG3_In-Top.csv")
#data["mid"] = load_data("SG3_In-Mid.csv")
#data["bot"] = load_data("SG3_In-Bot.csv")
#data["out"] = load_data("SG1_Bot.csv")

# SG2 Bot?
#data["top"] = load_data("SG2_In-Top.csv")
#data["mid"] = load_data("SG2_In-Mid.csv")
#data["bot"] = load_data("SG2_In-Bot.csv")
#data["out"] = load_data("SG1_Bot.csv")
