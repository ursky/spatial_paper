...
pick_open_reference_otus.py -i $PWD/seqs.fna -r $PWD/../Silva_Database.fa -o $PWD/otu_output --suppress_step4 -m usearch61 -p $PWD/../params.txt -v
...
../make_mapping_file.py otu_table.txt | sort > mapping_file.txt
wc -l otu_table.txt
